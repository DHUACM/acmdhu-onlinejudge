...
@NamedQueries({
    ...
    @NamedQuery(name = "SourceCode.findBySolutionId", query = "SELECT s FROM SourceCode s WHERE s.solutionId = :solutionId")
})
public class SourceCode implements Serializable {
    ...
    public String toString() {
        return "dhuoj.primeserver.entity.SourceCode[solutionId=" + solutionId + "]";
    }
