...
@Entity
@Table(name = "problem")
@NamedQueries({@NamedQuery(name = "Problem.findAll", query = "SELECT p FROM Problem p"), @NamedQuery(name = "Problem.findByProblemId", query = "SELECT p FROM Problem p WHERE p.problemId = :problemId"), @NamedQuery(name = "Problem.findBySource", query = "SELECT p FROM Problem p WHERE p.source = :source"), @NamedQuery(name = "Problem.findByTitle", query = "SELECT p FROM Problem p WHERE p.title = :title"), @NamedQuery(name = "Problem.findByProblemPath", query = "SELECT p FROM Problem p WHERE p.problemPath = :problemPath"), @NamedQuery(name = "Problem.findByInputPath", query = "SELECT p FROM Problem p WHERE p.inputPath = :inputPath"), @NamedQuery(name = "Problem.findByOutputPath", query = "SELECT p FROM Problem p WHERE p.outputPath = :outputPath"), @NamedQuery(name = "Problem.findByStdcodePath", query = "SELECT p FROM Problem p WHERE p.stdcodePath = :stdcodePath"), @NamedQuery(name = "Problem.findByCreateDate", query = "SELECT p FROM Problem p WHERE p.createDate = :createDate"), @NamedQuery(name = "Problem.findByTimeLimit", query = "SELECT p FROM Problem p WHERE p.timeLimit = :timeLimit"), @NamedQuery(name = "Problem.findByCaseTimeLimit", query = "SELECT p FROM Problem p WHERE p.caseTimeLimit = :caseTimeLimit"), @NamedQuery(name = "Problem.findByMemoryLimit", query = "SELECT p FROM Problem p WHERE p.memoryLimit = :memoryLimit"), @NamedQuery(name = "Problem.findByDefunct", query = "SELECT p FROM Problem p WHERE p.defunct = :defunct"), @NamedQuery(name = "Problem.findByContestId", query = "SELECT p FROM Problem p WHERE p.contestId = :contestId"), @NamedQuery(name = "Problem.findByAccepted", query = "SELECT p FROM Problem p WHERE p.accepted = :accepted"), @NamedQuery(name = "Problem.findBySubmit", query = "SELECT p FROM Problem p WHERE p.submit = :submit"), @NamedQuery(name = "Problem.findByError", query = "SELECT p FROM Problem p WHERE p.error = :error"), @NamedQuery(name = "Problem.findByDifficulty", query = "SELECT p FROM Problem p WHERE p.difficulty = :difficulty"), @NamedQuery(name = "Problem.findBySubmitUser", query = "SELECT p FROM Problem p WHERE p.submitUser = :submitUser"), @NamedQuery(name = "Problem.findBySolvedUser", query = "SELECT p FROM Problem p WHERE p.solvedUser = :solvedUser")})
public class Problem implements Serializable {
    ...
    public String toString() {
        return "cn.edu.dhu.acm.persistence.entity.Problem[problemId=" + problemId + "]";
    }
