...
package cn.edu.dhu.acm.oj.dbao;

import cn.edu.dhu.acm.oj.dbao.exceptions.NonexistentEntityException;
import cn.edu.dhu.acm.oj.dbao.exceptions.PreexistingEntityException;
import cn.edu.dhu.acm.oj.entity.Solution;
...
public class SolutionDBAO {
    ...
    public void create(Solution solution) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findSolution(solution.getSolutionId()) != null) {
                throw new PreexistingEntityException("Solution " + solution + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
