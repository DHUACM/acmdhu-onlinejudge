...
public class Solution implements Serializable {
    ...
    public Solution(Integer solutionId, int problemId, String userId, int runtime, int memory, Date submitDate, short result, short language, int contestId, short valid, int codeLength) {
        this.solutionId = solutionId;
    ...
    public String toString() {
        return "cn.edu.dhu.acm.persistence.entity.Solution[solutionId=" + solutionId + "]";
    }
